...
* if you want to touch at different coordinate on you phone you can pass the coordinate on `line 104`* `p.s dont't follow the line number shown in image below`
